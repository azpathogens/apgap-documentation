...
Note: You can also click the **Upload Files** button in the upper right corner of the Home page.

![Sequences Page](/images/nav-to-sequences.png)
![Sequences Page](/images/upload-sequences.png)
